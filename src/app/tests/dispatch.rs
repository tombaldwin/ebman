...
mod mutants_found_these {
    ...
    async fn abort_opens_a_confirm_modal() {
        let mut app = test_app();
        app.environments = vec![mk_env("api-prod", "poly", "WebServer", "Updating")];
        app.rebuild_view();
        app.table_state.select(Some(0));
    ...
    async fn the_confirm_lint_probe_skips_ssm_run_and_demo_mode() {
        ...
        demo.demo_mode = true;
        demo.environments = vec![mk_env("api-prod", "poly", "WebServer", "Green")];
        demo.rebuild_view();
        ...
        real.environments = vec![mk_env("api-prod", "poly", "WebServer", "Green")];
        real.rebuild_view();
